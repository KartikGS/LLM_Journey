...
6. **Output:** `/agent-docs/requirements/CR-XXX.md` + prompt for Senior Dev.
...
4. **MANDATORY OUTPUT:** Senior creates `/agent-docs/plans/CR-XXX-plan.md` using the Standard Plan Template defined in `/agent-docs/plans/TEMPLATE.md`.
