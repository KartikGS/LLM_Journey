...
- `agent-docs/llm-journey/workflow/reports/INVESTIGATION-CR-007-pipeline-regression.md`
- Demonstrates:
...
- `agent-docs/llm-journey/workflow/requirements/CR-007-pipeline-stabilization.md`
- Demonstrates:
