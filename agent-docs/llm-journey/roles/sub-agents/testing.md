...
-   **Authority**: Responsible for validating architectural assumptions via tests. 
    ...
    - **Priority**: Resolving the discrepancy via the [Feedback Protocol](/agent-docs/llm-journey/communication/coordination/feedback-protocol.md) is your top priority.
...
- **Task Instructions:** [Tech Lead To Testing](/agent-docs/llm-journey/communication/conversations/tech-lead-to-testing.md)

## Execution Responsibilities

- Follow the instructions provided by the Tech Lead agent in the [Tech Lead To Testing Handoff](/agent-docs/llm-journey/communication/conversations/tech-lead-to-testing.md)
- Make a report for the Tech Lead agent in the [Testing To Tech Lead Handoff](/agent-docs/llm-journey/communication/conversations/testing-to-tech-lead.md)
...
Before writing or modifying tests, publish a short **Preflight** note in `/agent-docs/llm-journey/communication/conversations/testing-to-tech-lead.md` with:
...
- **Use Feedback Protocol**: File a report in `/agent-docs/llm-journey/communication/conversations/testing-to-tech-lead.md` under `## BLOCKER / FEEDBACK`. Note: This includes environmental configs like `next.config.ts`. If a test fails due to a system-wide setting, you MUST NOT modify that setting yourself.
...
When reporting E2E failures in `/agent-docs/llm-journey/communication/conversations/testing-to-tech-lead.md`, include a `Reproduction Matrix` table with:
- command,
...
Read `agent-docs/llm-journey/communication/conversations/TEMPLATE-testing-to-tech-lead.md` before writing your report.

### Environmental & Tooling Quirks
If tests fail due to the environment (e.g., Playwright version mismatch, CI vs local diffs):
- Document the mismatch in the `/agent-docs/llm-journey/communication/conversations/testing-to-tech-lead.md` report.
