...
|---|---|---|
| `$[PROJECT]_THINKING` | `/agent-docs/[project]/thinking/main.md` | General principles — cross-role operational rules |
| `$[PROJECT]_THINKING_REASONING` | `/agent-docs/[project]/thinking/reasoning.md` | Reasoning framework — how to think through problems |
| `$[PROJECT]_THINKING_KEEP_IN_MIND` | `/agent-docs/[project]/thinking/keep-in-mind.md` | Operational reminders — hard stops and common failure modes |
