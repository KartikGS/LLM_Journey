...
Development guidance scattered as flat files at the root of `agent-docs/` becomes hard to discover as a project grows. Grouping development artifacts under a named folder makes the technical layer navigable: agents know where to look, and the structure communicates which concerns belong together.
...
1. Create the folder at `agent-docs/[project]/development/`.
