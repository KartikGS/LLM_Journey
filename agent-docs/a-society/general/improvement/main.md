...
- Cross-project agent standards live in named cross-project directories
- Project-specific content lives under a named project subfolder
- Each project subfolder contains its own domain-scoped folders
