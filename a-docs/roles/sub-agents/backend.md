...
- **Task Instructions:** [Tech Lead To Backend](/LLM_Journey/a-docs/communication/conversations/tech-lead-to-backend.md)

## Execution Responsibilities

- Read the handoff at [Tech Lead To Backend](/LLM_Journey/a-docs/communication/conversations/tech-lead-to-backend.md) and implement per its scope.
- Write the completion report at [Backend To Tech Lead](/LLM_Journey/a-docs/communication/conversations/backend-to-tech-lead.md) using the [report template](/LLM_Journey/a-docs/communication/conversations/TEMPLATE-backend-to-tech-lead.md).
...
## Checklist
-   [ ] Before replacing `backend-to-tech-lead.md`: completed the Conversation File Freshness Pre-Replacement Check per `$LLM_JOURNEY_WORKFLOW` (prior CR plan exists + prior file shows `status: completed`)?
