...
- **Task Instructions:** [Tech Lead To Frontend](/LLM_Journey/a-docs/communication/conversations/tech-lead-to-frontend.md)

## Execution Responsibilities

- Follow the instructions provided by the Tech Lead agent in the [Tech Lead To Frontend Instructions](/LLM_Journey/a-docs/communication/conversations/tech-lead-to-frontend.md)
- Use [Frontend To Tech Lead Report Template](/LLM_Journey/a-docs/communication/conversations/TEMPLATE-frontend-to-tech-lead.md) when drafting the active CR report in [Frontend To Tech Lead Report](/LLM_Journey/a-docs/communication/conversations/frontend-to-tech-lead.md)
