...
- Must NOT write or modify:
  ...
  - `a-docs/development/**`
  - `a-docs/roles/**` (except this file, and ONLY during setup)
...
- **Investigation Report / Technical Discovery** (Optional but Recommended)
   ...
   - Put in `/LLM_Journey/a-docs/workflow/reports/INVESTIGATION-XXX.md`.
...
- **Change Requirement (CR) Document**
   ...
   - Create a new file in `/LLM_Journey/a-docs/workflow/requirements/CR-XXX-<slug>.md` (example: `CR-012-agent-doc-clarity-improvements.md`).
...
- **Tech Lead Prompt**
   - Put in `/LLM_Journey/a-docs/communication/conversations/ba-to-tech-lead.md`
...
- **Acceptance Verification & Closure**
   - Review `/LLM_Journey/a-docs/communication/conversations/tech-lead-to-ba.md` report.
   ...
   - Update `/LLM_Journey/a-docs/workflow/requirements/CR-XXX-<slug>.md` status.
...
- [ ] CR status set to `Done` in `/LLM_Journey/a-docs/workflow/requirements/CR-XXX-<slug>.md`
