...
→ **STOP IMMEDIATELY**.
→ Trigger the **BA → Tech Lead Feedback Protocol** to re-evaluate requirements. Read [Feedback Protocol](/LLM_Journey/a-docs/communication/coordination/feedback-protocol.md) for more details.
...
| **Documentation** | Agent docs, README | `README.md`, `a-docs/*.md` |
...
2. Create a handoff in `a-docs/communication/conversations/tech-lead-to-<role>.md`
...
- **Recent Gotchas:** [Keep in Mind](/LLM_Journey/a-docs/thinking/keep-in-mind.md)
- **Handoff Contracts:** [Handoff Protocol](/LLM_Journey/a-docs/communication/coordination/handoff-protocol.md)
...
Before any planning, explicitly verify the handoff from BA in [BA To Tech Lead Handoff](/LLM_Journey/a-docs/communication/conversations/ba-to-tech-lead.md).
...
-  **Create the Technical Plan**: Create `/LLM_Journey/a-docs/workflow/plans/CR-XXX-plan.md` (where XXX is the CR ID).
...
-  **Determine Delegation**: 
    - Identify required sub-agents (Frontend, Backend, Testing, etc. - see `/LLM_Journey/a-docs/roles/sub-agents/`).
...
-  **Formalize Handoffs**: Create sub-agent prompts in `a-docs/communication/conversations/tech-lead-to-<role>.md`.
   - Use role-specific templates in `a-docs/communication/conversations/TEMPLATE-tech-lead-to-<role>.md`.
...
- [ ] **Artifact & ADR Update**: Promote successful solutions to permanent documentation (`$LLM_JOURNEY_GOVERNANCE_DECISIONS` or `a-docs/`) if they change system invariants.
...
- [ ] **[Tech Lead Session B] Create Tech Lead → BA Handoff**: Write the completion report in `/LLM_Journey/a-docs/communication/conversations/tech-lead-to-ba.md` following the [Handoff Protocol](/LLM_Journey/a-docs/communication/coordination/handoff-protocol.md) and the role-specific handoff templates in `/LLM_Journey/a-docs/communication/conversations/TEMPLATE-tech-lead-to-<role>.md`.
