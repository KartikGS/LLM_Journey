...
- **Output:** `a-docs/improvement/reports/META-YYYYMMDD-<CR-ID>-lightweight.md`
...
`a-docs/improvement/reports/META-YYYYMMDD-<CR-ID>-<role>-findings.md`
...
- @a-docs/improvement/reports/META-YYYYMMDD-<CR-ID>-<prior-role>-findings.md
...
**Output per agent:**
`a-docs/improvement/reports/META-YYYYMMDD-<CR-ID>-<role>-findings.md`
> Note: Create the `a-docs/improvement/reports/` directory if it does not yet exist before writing findings files.
...
**Output:** `a-docs/improvement/reports/META-YYYYMMDD-<CR-ID>-synthesis.md`
...
Output:
- `a-docs/improvement/reports/ALIGN-YYYYMMDD-backlog.md` with entries tagged by lens (`portability`, `collaboration`, `evolvability`).
