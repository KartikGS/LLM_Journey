...
- For observability design principles and instrumentation decision rules (when to use spans vs. metrics+logs), see [`a-docs/project-principles/observability.md`](/LLM_Journey/a-docs/project-principles/observability.md) — specifically the **Purposeful Observability Principle**.
